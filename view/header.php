...
<body>
    <div class="containerfull padd20">
        <div class="container">
            ...
            <div class="menu col8">
                <div class="col3">
                    <form action="index.php?pg=sanpham" class="search-bar" method="post">
                        <input type="text" name="kyw" id="" style="min-width: 230px;" placeholder="Nhập từ khóa tìm kiếm theo tên">
