...
function sanpham_insert($name, $img, $price, $view, $bestseller, $iddm){
    $sql = "INSERT INTO sanpham(name, img, price, view, bestseller, iddm) VALUES (?,?,?,?,?,?)";
    pdo_execute($sql, $name, $img, $price, $view, $bestseller, $iddm);
}
...
function showsp($dssp){
    ...
    foreach ($dssp as $sp) {
        ...
        $html_dssp.='<div class="box25 mr15">
                            ...
                            <span class="dssp_name">'.$name.'</span>
